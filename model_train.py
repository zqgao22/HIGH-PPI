...
parser.add_argument('--vec_path', default='./vec5_CTC.txt', type=str,
...
def main():
    ...
    ppi_data.split_dataset(train_valid_index_path='./train_val_split_data/train_val_split_6.json', random_new=True,
                           mode=args.split)
    graph = ppi_data.data
    ...
    save_path = os.path.join(save_path, "gnn_{}_{}".format('training_6_1', time_stamp))
